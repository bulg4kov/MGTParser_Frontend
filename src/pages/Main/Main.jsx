        ...
        <main className={classes.Main}>
            ...
            <article className={classes.Main__inner}>
                ...
                <article className={classes.Main__action}>
                    <h3 className={classes.Main__actionTitle}>
                        Начните сейчас
                    </h3>
